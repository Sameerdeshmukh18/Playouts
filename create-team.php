...
if(isset($_POST['submit']))
{
    ...
    $teamRating  =  $_POST['teamRating'];
   


    $insert  = mysqli_query($con, "INSERT INTO teams (team_name, team_leader_id,teamRating) VALUES ('$teamName', '$team_leader_id','$teamRating') ");
          ...
          ?> 
            ...
            <?php  if($numRows) {
                ...
                <div class="title">
                  ...
                  <button class="btn btn-primary float-right ml-4" data-toggle="modal" data-target="#exampleModal"> Add Player</button>
               </div>

               <h5>Players of <?= $teamd['team_name'] ?></h5>
                    ...
                    <div class="row">
                          <div class="col-lg-12 table-responsive" >
                              <table class="table  table-bordered" style="max-width:100%">
                                  ...
                                  <tbody>
                                    <?php $playersQuery  = mysqli_query($con, "SELECT * FROM users WHERE team_id='".$teamd['id']."' "); 
                                           $count = 1;
                                           while ($players  = mysqli_fetch_assoc($playersQuery) ) {
                                               # code...
                                               ?>

                                            <tr>
                                                <td> <?= $count++; ?> </td>
                                                <td> <?= $teamd['team_name']  ?> </td>
                                                <td> <?= $teamd['teamRating'] ?> </td>
                                                <td> <?= $players['name'] ?> </td>
